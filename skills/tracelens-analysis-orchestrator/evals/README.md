...
All eval results use a 7-column CSV schema: `index, category, issue_summary, result, details, root_cause, recommended_fix`. See [EVAL_RUBRICS.md](https://github.com/AMD-AGI/TraceLens/blob/5086f53f0fcd234f724eed418e4a983a8cafb469/EVAL_RUBRICS.md) for the full rubric reference.
